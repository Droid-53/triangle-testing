...
class Triangle {
    ...
    public boolean isRight() {
        ...
        if ((((l1 * l1) + (l2 * l2) == (l3 * l3)) || ((l1 * l1) + (l3 * l3) == (l2 * l2)) || ((l2 * l2) + (l3 * l3) == (l1 * l1))) && isTriangle()) {
            return true;
        } else {
            return false;
        }
    ...
    void getArea(float l1, float l2, float l3){
        ...
        System.out.print(Math.pow(areaSqrt, .5));
    }
...
class TestClass {
    ...
    public static void TriangleAnswer() {
        Scanner scanner = new Scanner(System.in);
        String s1, s2, s3;
    ...
    public static void PointAnswer() {
        Scanner scanner = new Scanner(System.in);
